...
# 加载中文字体
font_path ="D:\python\好玩的代码\XiaoDouDaoShanZhongYueJian-Shan-ChangGui(REEJI-Xiaodou-MoonGB-Flash-Regular)-2.ttf"  # 将 'your_font_path.ttf' 替换为你的字体文件路径
...
while running:
    ...
    # 绘制文字
    text = font.render("生日快乐", True, WHITE)
